...
#include "../../../../../Image_Stitcher_Auto/droparea.h"
...
void DropArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DropArea::*)(const QStringList & )>(_a, &DropArea::filesDropped, 0))
            return;
    }
}
...
// SIGNAL 0
void DropArea::filesDropped(const QStringList & _t1)
{
